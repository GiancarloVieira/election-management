...
public class SQLCandidateRepository implements CandidateRepository {
    ...
    public void deleteById(String id) {
        entityManager.createQuery("DELETE FROM Candidate c WHERE c.id = :id")
                .setParameter("id", id)
                .executeUpdate();
    }

    @Override
    public List<Candidate> findPaginated(int page, int pageSize) {
        return entityManager.createQuery("SELECT c FROM Candidate c", infrastructure.repositories.entities.Candidate.class)
